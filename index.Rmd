...
1. A disease tracking program that takes as input a list of names, dates, and genome sequences of a specific disease to track its spread
[link]("https://github.com/dokastho/s2021-p1-epidemiology")
2. An implementation of a hash table
[link]("https://github.com/dokastho/hash-table")
3. An algorithm to heuristically solve the knapsack problem
[link]("https://github.com/dokastho/knapsack-snapshot")
4. An implementation of a data type that I had no prior understanding of, namely a skip list
[link]("https://github.com/dokastho/skip-list")
5. A demonstration of the benefits of dynamic programming
[link]("https://github.com/dokastho/fib-dp-snapshot")
:::
## Hobbies
