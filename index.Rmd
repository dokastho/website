...
1. ![A disease tracking program that takes as input a list of names, dates, and genome sequences of a specific disease to track its spread](assets/images/tracker.png)
[Github Repo](https://github.com/dokastho/s2021-p1-epidemiology)
